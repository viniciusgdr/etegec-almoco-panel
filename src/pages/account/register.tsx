...
export default function Register() {
  ...
  const redirectUrl = `?redirect=${router.query.redirect || '/'}`
  return (
          ...
          <div className="bg-base-200 rounded-3xl border-4 border-slate-700">
            <form className="flex flex-col items-center justify-center w-full p-5 rounded shadow-xl">
              ...
              </div>
              {
                buttonAsLogin && (
                  <button
                    ...
                    onClick={
                      () => {
                        router.push('/account/login' + redirectUrl)
                      }
                    }
                  >
                    Login
              ...
              <div className="flex flex-col items-center justify-center w-full pt-4">
                ...
                <Link href={"/account/login" + redirectUrl} className="text-sm font-bold text-blue-500 uppercase hover:text-blue-600">Faça login!</Link>
              </div>
            </form>
          </div>
        </div>
